...
'parse':
	...
	'action_dict': None, # action dict, will be filled once env is created
	'cur_curriculum_level': 5, # starting level, determine number of blocks, in {0 (uniform), 1, ..., stack_max_blocks}
	},
...
'add':
	...
	'cur_curriculum_level': 4, # {-1, 1,2,...,stack_max_blocks} starting level, determine length of original parse goal and nprocesses
	},
