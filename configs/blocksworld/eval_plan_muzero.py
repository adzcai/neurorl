...
python configs/blocksworld/eval_plan_muzero.py 
'''

if __name__ == "__main__":
  random.seed(0)
  main(
        eval_lvls=True, lvls=[3,4,5], # whether to eval on varying num blocks, nblocks also varied
        ...
        groupname='M5onlycomp2max5-10-7', # model to load
      )
